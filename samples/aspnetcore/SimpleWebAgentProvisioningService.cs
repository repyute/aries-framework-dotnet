...
{
    public class SimpleWebAgentProvisioningService : IHostedService
    {
        internal const string MobileAppInvitationTagName = "MobileAppInvitationId";
        ...
        public SimpleWebAgentProvisioningService(
        ...
        public async Task StartAsync(CancellationToken cancellationToken)
        {
            ...
            if (provsioningRecord.GetTag(MobileAppInvitationTagName) != null)
            {
                return;
            }
            ...
            provsioningRecord.SetTag(MobileAppInvitationTagName, record.Id);
